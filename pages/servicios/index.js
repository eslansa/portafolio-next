      ...
      <div className='container mx-auto'>
        <div className='flex flex-col xl:flex-row gap-x-8'>
          ...
          <div className='text-center flex xl:w-[30vw] flex-col lg:text-left mb-4 xl:mb-0'>
            ...
            > Puedes contactarme para trabajar en cualquiera de estos servicios, me siento cómodo trabajando en ellos. Será un placer poder ayudarle a usted como cliente que es la prioridad.
            </motion.p>
          </div>
          {/* slider */}
          <motion.div
