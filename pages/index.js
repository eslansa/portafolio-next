    ...
    <div className='bg-primary/60 h-full '>
      ...
      <div className='w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10'>
        <div className='text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto'>
          ...
          >
            Soy Eslán Sánchez Alvarez, tengo 22 años, estoy estudiando Ingienería en Ciencias Informáticas en la UCI, La Habana. Me fascina el desarrollo web, sobre todo el Frontend. <br /> Revisa mis proyectos y visita la página.
          </motion.p>
          {/* btn */}
